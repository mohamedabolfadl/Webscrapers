...
meals = []
strs = []
#baselink = "https://urlaub.check24.de/suche/hotel?airport=BLL,BRE,BSL,CGN,CSO,DRS,DTM,DUS,EIN,ENS,ERF,FDH,FKB,FMM,FMO,FRA,GWT,HAJ,HAM,HDF,HHN,INN,KSF,LBC,LEJ,LGG,LUX,MST,MUC,NRN,NUE,PAD,PRG,RLG,SCN,STR,SXB,SXF,SZG,SZW,TXL,ZQW,ZRH&adult=2&departureDate=2016-11-01&returnDate=2017-02-28&travelDuration=1w&catering=allinclusive&countryId=69&regionId=1079&recommendation=-&sorting=categoryDistribution&order=asc&regionSort=topregion&regionSortOrder=asc&extendedSearch=1&oceanView=0&page="
baselink = "https://urlaub.check24.de/suche/hotel?airport=BLL,BRE,BSL,CGN,CSO,DRS,DTM,DUS,EIN,ENS,ERF,FDH,FKB,FMM,FMO,FRA,GWT,HAJ,HAM,HDF,HHN,INN,KSF,LBC,LEJ,LGG,LUX,MST,MUC,NRN,NUE,PAD,PRG,RLG,SCN,STR,SXB,SXF,SZG,SZW,TXL,ZQW,ZRH&adult=2&departureDate=2016-11-01&returnDate=2017-02-28&travelDuration=1w&catering=allinclusive&regionId=764&recommendation=-&sorting=categoryDistribution&order=asc&regionSort=topregion&regionSortOrder=asc&extendedSearch=1&oceanView=0&page="
while pc<=npages :
    print "page:"+str(pc)
...
os.chdir(homedir)
destination = "Dubai_light_"+time.strftime("%d-%m-%Y")+"_"+time.strftime("%I-%M-%S")+"_AllInklusiv"
